...
Assemble the Smart Plant Tower hardware according to the system schematics and prototype design.

Install Arduino IDE and configure ESP32 board support.

Upload the ESP32 firmware to the microcontroller.

Configure Firebase credentials in the firmware and mobile application.

Install the mobile application on an Android or iOS device.

Power the system using solar energy or AC fallback through the transfer switch.

Usage

Power on the Smart Plant Tower.

Connect the ESP32 to Wi-Fi.

Launch the mobile application and log in.
...
Control irrigation and lighting manually or allow automated operation.
...
UV Grow Lighting Control with manual mode
